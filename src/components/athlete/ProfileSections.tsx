...
export function ProfileDisplaySections({ profile, trackingDeviceLabel }: { profile: AthleteProfile; trackingDeviceLabel?: string }) {
  ...
  return (
    <div className="flex flex-col gap-3">
      {/* Tracking device (top-level field, shown outside questionnaire to avoid duplication in Stammdaten) */}
      {trackingDeviceLabel && (
      ...
      <AccordionSection title="Coaching-Fragebogen" variant="outer">
        {/* Lifestyle */}
